...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.example.android.invetoryapp/products/2"
    ...
    private void insertProduct() {
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, "Notepad");
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 1);
        values.put(ProductEntry.COLUMN_PRODUCT_QUANTITY, 10);
        values.put(ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME, "Udacity");
        values.put(ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER, "0633744021");
